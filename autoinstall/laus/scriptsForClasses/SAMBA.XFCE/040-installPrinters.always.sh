...
case $(hostname) in
  r401pc01 )
    /usr/sbin/lpadmin -p CANON-BE -v smb://nwboxuser:123@smb01/CANON-BE -P /nwbox/public/ppd/canon-be.ppd -E
  ...
  ;;
  r408*)
    /usr/sbin/lpadmin -p HL5340-EDV2 -v smb://nwboxuser:123@smb01/HL5340D-EDV2 -P /nwbox/public/ppd/hl5340-edv2.ppd -E
